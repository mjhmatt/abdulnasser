...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_enqueue_script('modernizr'); // Enquefoue it!
        ...
        wp_register_script('bxslider', get_template_directory_uri() . '/js/bxslider.js', array('jquery'), '1.0.0'); // Custom scripts
...
function html5blank_styles()
{
    ...
    wp_register_style('bxslider', get_template_directory_uri() . '/css/bxslider.css', array(), '1.0', 'all');
